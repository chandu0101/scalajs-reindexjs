...
homepage := Some(url("https://github.com/chandu0101/scalajs-reindexjs"))
...
pomExtra :=
  <scm>
    <connection>scm:git:github.com:chandu0101/scalajs-reindexjs</connection>
    <developerConnection>scm:git:git@github.com:chandu0101/scalajs-reindexjs.git</developerConnection>
    <url>github.com:chandu0101/scalajs-reindexjs.git</url>
  </scm>
    <developers>
      <developer>
        <id>chandu0101</id>
